...
iPad 主持人控制台 — 純前端 PWA，無後端、可離線、可加到主畫面。規則對齊 **v1.4.1**。

## 功能

- 開新局：4–6 人、十面骰決定每人初始福/慧、最高者擲白×黑訂文明高度（白骰 × 黑骰 ＋ 玩家人數 × 10）
- 玩家卡：福報 / 智慧 / 文明只讀顯示；改分走加減分（可勾「這是本輪行動」）；起始點經過／停格一鍵加分（同時標記本輪已行動）
...
- 社會福利救濟：前 3 輪（或文明 < 25%）福慧從正數歸零可救，每人每局一次；抽卡與加減分跳出提示由主持人啟動；氣候調節主動換文明不救；恢復到 3，下兩輪幸運庇護 ×1.5／×0.5（終局覆蓋）
...
| `config.js` | 天氣時程、兌換率、倍率、救濟參數等規則旋鈕 |
| `docs/social-welfare-relief.md` | 社會福利救濟可實作規格 |
